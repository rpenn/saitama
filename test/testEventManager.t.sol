...
contract testEventManager is Test {
    ...
    function testRevertIfEventIdIsLessThanCurrentEventId() public {
        ...
        eventManager.editEvent(2, "F1", "Japan Suzuka", 200, 1000, "Max wins the championship", 10**17, 50000);
    }
    ...
    function testRevertWhenMsgSenderIsNotCreator() public {
        ...
        eventManager.editEvent(1, "F1", "Japan Suzuka", 200, 1000, "Max wins the championship", 10**17, 50000);
    }

    function testEventNameIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F2", "Japan Suzuka", 200, 1000, "Max wins the championship", 10**17, 50000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
    ...
    function testEventLocationIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F1", "Singapore GP", 200, 1000, "Max wins the championship", 10**17, 50000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
    ...
    function testEventStartTimeIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F1", "Japan Suzuka", 250, 1000, "Max wins the championship", 10**17, 50000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
    ...
    function testEventEndTimeIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F1", "Japan Suzuka", 200, 1500, "Max wins the championship", 10**17, 50000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
    ...
    function testEventDescriptionIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F1", "Japan Suzuka", 200, 1500, "Ferrari win the championship?", 10**17, 50000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
    ...
    function testEventPriceIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F1", "Japan Suzuka", 200, 1000, "Max wins the championship", 10**18, 50000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
    ...
    function testEventTicketQuantityIsEditedCorrectly() public {
        testCreateEvent();
        eventManager.editEvent(1, "F1", "Japan Suzuka", 200, 1000, "Max wins the championship", 10**17, 60000);
        uint256 currentEventId = eventManager.getCurrentEventId();
        EventManager.Event memory currentEvent = eventManager.getEvent(currentEventId);
